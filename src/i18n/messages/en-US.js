...
export default {
  [LOCALES.ENGLISH]: {
    ...
    team: 'Team',
    // Project Description
    descProjectPresentations: `Project's Presentations`,
    descTheGuitaReact: 'The GuitaReact is a web app where you can add songs from your favorite artists and play the video clips randomly. Also you can play them randomly with one of its new features, BPM (beat per minute) that way you can practice the added songs with the beat you want to practice with your instrument. If you have many songs added, you have the opportunity to create a Custom List, you will play the songs that you selected and even you can save the custom list if you want to. This application is ideal if your intention is to play music without feeling you doing this repetitively. Make random surprises and have fun.\n\nThe GuitaReact (Remake) is a project that I decided to work on again for many reasons, but the main goal  was building with elements that I have learnt in my journey as developer and working with the current elements that I used in the previous version. I got excited working on this project because I want to do it from scratch. Starting with the design, to visualize how it’s going to look on each screen. Even with the colors (I got inspired by The White Stripes and Jack White,  they combine two or three colors and they tend to use primary colors).\n\nAnother focus that I had for the project was that I wanted to work with the current React.js. it means, with hooks, custom hooks, arrows functions. How am I going to work with redux (redux-toolkit) because the current setting is totally different as I did before if I wanted to keep Firebase/Firestore to save data for the project.\n\nIf I used the original project and I have a big appreciation, this one has it on another level, not just it is the newest, it is for the concept that I had. I could do this possible from the beginning. It wasn’t an easy task because I had to check what I could use, what I couldn’t and how I was going to organize the new implementations. This allows me to see that I’m capable of working in a project where design and functionality work together, and I like in a certain way the project reflects the person I am at this moment.',
